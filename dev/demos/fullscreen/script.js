...
(function() {
    window.onload = function() {
	    fullscreen = new Fullscreen(document.getElementById("screen"));
	    fullscreen.start();
        document.querySelector('button').addEventListener('click', fullscreen.toggle_fullscreen.bind(fullscreen));
    }
})();
